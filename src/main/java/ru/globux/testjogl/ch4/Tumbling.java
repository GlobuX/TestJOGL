...
public class Tumbling implements GLEventListener {
    ...
    public Tumbling() {
        ...
        glWindow.setTitle("Chapter 4 - program 1c");
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        mMat.identity();
        mMat.translate(
                (float) Math.sin(0.35f * tf) * 2.0f,
                (float) Math.sin(0.52f * tf) * 2.0f,
                (float) Math.sin(0.70f * tf) * 2.0f
        );
        mMat.rotateXYZ(
                1.75f*(float) tf,
                1.75f*(float) tf,
