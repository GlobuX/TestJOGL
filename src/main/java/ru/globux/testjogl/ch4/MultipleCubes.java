...
public class MultipleCubes implements GLEventListener {
    ...
    public MultipleCubes() {
        ...
        glWindow.setTitle("Chapter 4 - program 1d");
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        // use tf (time factor) to compute different translations in xc, y, and z
        ...
        for (int i = 0; i < 24; i++) {
            ...
            mMat.identity();
            mMat.translate(
                    (float) Math.sin(0.35f * x) * 8.0f,
                    (float) Math.sin(0.52f * x) * 8.0f,
                    (float) Math.sin(0.70f * x) * 8.0f
            );
            mMat.rotateXYZ(
                    1.75f*(float) x,
                    1.75f*(float) x,
